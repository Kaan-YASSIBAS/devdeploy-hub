...
- **Phase 2J.19 (next) - Runtime Resource Import and Adoption Design:** define explicit review, ownership, desired-manifest generation, and conflict handling before adding any import or adoption action. GitOps destroy and prune controls remain separate future work.
