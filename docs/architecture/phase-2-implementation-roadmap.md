...
- **Phase 2J.27b (next) - Observability Stack Bootstrap and Smoke Plan:** turn the selected local observability model into a reproducible, idempotent bootstrap/smoke sequence for the workload cluster without exposing internal observability services to the frontend.
