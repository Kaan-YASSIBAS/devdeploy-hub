...
- **Phase 2J.14 (next) - Runtime Resource Import and Adoption Design:** define explicit review, ownership, desired-manifest generation, and conflict handling before adding any import or adoption action.
