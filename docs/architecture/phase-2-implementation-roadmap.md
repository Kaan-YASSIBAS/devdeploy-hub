...
- **Phase 2J.5d (next):** compose the writer, local commit adapter, and push adapter into an internal deploy operation service without direct Kubernetes deployment.
